...
- Published to `ghcr.io/schlomo/lidl-plus` via [`.github/workflows/ci-cd.yml`](.github/workflows/ci-cd.yml) on merge to `main` (`latest`, `1.<commit-count>.0`, short git SHA; multi-arch description via manifest annotations).
